...
Μπορείτε ακόμα να ολοκληρώσετε τη δραστηριότητα, αλλά δεν θα μπορείτε να υποβάλετε το πρόγραμμά σας για εκτέλεση στον ISS. Ο επόμενος γύρος της πρόκλησης θα ξεκινήσει τον Σεπτέμβριο του 2024. Ελέγξτε τα μέσα κοινωνικής δικτύωσης και εγγραφείτε στο ενημερωτικό δελτίο στον ιστότοπο [Astro Pi](https://astro-pi.org/mission-zero/) για ενημερώσεις.
