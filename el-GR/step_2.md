...
Γι΄ αυτή την αποστολή, θα χρησιμοποιήσετε τον εξομοιωτή Sense HAT. Ο εξομοιωτής είναι ένα μέρος λογισμικού που προσομειώνει όλες τις λειτουργίες του Astro Pi στο πρόγραμμα περιήγησης Ιστού σας.
