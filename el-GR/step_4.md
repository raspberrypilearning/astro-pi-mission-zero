...
Για όποια εικόνα επέλεξες, το φόντο χρησιμοποιεί τη μεταβλητή `c` η οποία είναι αρχικοποιημένη ως μαύρη.
...
Πρόσθεσε `sense.clear()` στο τέλος του κώδικά σου για να καθαρίσεις την εικόνα στο τέλος του βρόχου σου. Αυτό θα σε βοηθήσει να δεις πότε θα τελειώσει η εκτέλεση του κινούμενου σχεδίου.
