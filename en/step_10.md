...
If you're feeling confident, you could take part in [Mission Space Lab](https://astro-pi.org/missions/space-lab/)! Form a team of two to six people, and work like real space scientists to design your own experiment. Receive free computer hardware for your experiment, and write the Python code to carry out your experiment.
If you get flight status, your code will be uploaded to the International Space Station and run for three hours (two orbits). Any data your code gathers in space — image or sensor data files — will be downloaded and returned to you for analysis.
