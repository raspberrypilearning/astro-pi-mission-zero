...
Here is one of the original Mark I Astro Pi units on the International Space Station, running some code written by students. The new versions of the Astro Pis are where your code will eventually be run!
