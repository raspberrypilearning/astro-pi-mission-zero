...
# A további képek / képkockák ide kerülnek:
...
# Ismételd 14-szer (14 * 2 másodperc = 28 másodperc összesen az animációnak)
for i in range(14):
  # A második kép megjelenítése
  sense.set_pixels(kep2)
  sleep(1)
...
# Az EGYSZERŰ PÁLYAMŰ itt elkészült
