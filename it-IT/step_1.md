...
Completa questo progetto per accedere a [Astro Pi Mission Zero](https://astro-pi.org/mission-zero){:target="_blank"} ed eseguire il tuo codice nello spazio su un computer Astro Pi.
