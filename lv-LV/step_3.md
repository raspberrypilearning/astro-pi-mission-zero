...
Atveriet [Mission Zero sākuma projektu](https://missions.astro-pi.org/lv/mz/code_submissions/){:target="_blank"}.
...
```python
c = (0, 0, 0)       # Melns
k = (46, 139, 33)   # Lapu zaļš
t = (255, 255, 0)   # Tīri dzeltens
...
```python
a = (255, 255, 255) # Baltā
v = (255, 177, 177) # Maigi rozā
y = (248, 97, 255)  # Fuksīns
o = (179, 96, 65)   # Terakota brūns
c = (0, 0, 0)       # Melns
...
b = (171, 171, 171) # Pelēks
c = (0, 0, 0)       # Melns
q = (255, 0, 0)     # Tīri sarkans
j = (0, 255, 0)     # Tīri zaļš
k = (46, 139, 33)   # Lapu zaļš
n = (126, 88, 25)   # Zemes brūns
