...
Mark II Astro Pi-maskinvaren er så ny at datamaskinene ikke engang har navn ennå. Du kan være med å velge hva de skal hete ved å delta i "Gi de nye Astro Pi -datamaskinene navn" -konkurransen og inkludere favorittnavnet ditt som en del av Mission Zero-programmet.
